#source: https://github.com/puzzledqs/BBox-Label-Tool
...
##        self.loadDir()
    ...
    def loadDir(self, dbg = False):
        ...
        self.imageDir = os.path.join('/Users/jennifercooper/Projects/Tesla/PyTorchTraining/Potholes/data/train/', str(self.imgclass))
        print(self.imageDir)
        ...
        self.total = len(self.imageList)
         ...
         # set up output dir
        self.outDir = os.path.join('/Users/jennifercooper/Projects/Tesla/PyTorchTraining/Potholes/data/train/', str(self.imgclass))
